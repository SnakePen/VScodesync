...
" language PATH
let g:python3_host_prog = expand('C:\Program Files\Python39\python.exe')
...
autocmd filetype cpp nnoremap <f5> :w <bar> !g++ -std=c++17 % -o %:r <cr> :vnew <bar> <cr><cr>
